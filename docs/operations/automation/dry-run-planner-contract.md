...
```yaml
issue_drafts: [{work_package_id: "", renderer_version: "issue-template@1.0.0-proposal", canonical_fields: {}, title: "", body: "", labels: [], milestone: null, parent_issue: null, existing_issue_candidate: null, duplicate_check: {}, source_links: []}]
```
