...
graph_id: "WG-<calculated-uuidv5>", graph_revision: 1, source_snapshot: {repository: "https://github.com/woojinhong/Metabus_social", repository_sha: ce168d5381015e46171a13c2a3b2b80509c299b1, requirement_set_digest: "sha256:<placeholder>", work_package_set_digest: "sha256:<placeholder>", policy_version: "workgraph@1.0-proposal"},
...
[CONFIRMED] 이번 단계는 계약만 문서화하며 Validator, Runtime Ledger, Dispatcher, outbox를 구현하거나 저장 기술을 확정하지 않는다. [OPEN] UUID namespace URI, canonical JSON, Ledger 기술, heartbeat/lease와 fence 초기값/overflow, SOFT_REQUIRES 차단 policy와 Graph revision migration을 후속 승인에서 정한다.
