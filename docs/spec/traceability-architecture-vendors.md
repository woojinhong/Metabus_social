...
| delivery | [web/mobile research](../research/technology/web-mobile-options.md) | React/Vite PWA first | [ADR-002](../adr/ADR-002-web-first-delivery.md) | D-024 and device thresholds |
...
| durable data | [database research](../research/technology/database-options.md) | NCP Cloud DB for PostgreSQL | [ADR-004](../adr/ADR-004-postgresql-primary-store.md) | version, restore/failover; schema after UX |
