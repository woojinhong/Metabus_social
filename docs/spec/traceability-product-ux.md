...
related_documents:
  ...
  - ux/README.md
decision_authority: D-001 through D-007 and D-024
---
...
- Seoul broad activity area; ages 25–39; reached 19th birthday; mutually compatible heterosexual Pilot.
- Exactly six participants with a 3 women / 3 men target; incomplete admission fails closed.
- Ninety minutes: rules, three 15-minute games, free conversation, initial private interest, consented limited reveal, final private interest, close/recovery buffer.
...
| session/game/microphone/pass/reconnect | [session wireflow](ux/session-wireflow.md) |
| disclosure/interest/no-match | [disclosure wireflow](ux/progressive-disclosure-wireflow.md) |
